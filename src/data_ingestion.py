...
def load_data(data_url: str) -> pd.DataFrame:
    try:
        ...
        print(f"Error: An unexpected error occurred while leading the data.")
        print(e)
        raise 
...
def main():
    try:
        df = load_data("https://raw.githubusercontent.com/HARSHALKUMRE/Main-Branching/refs/heads/main/tweet_emotions.csv")
